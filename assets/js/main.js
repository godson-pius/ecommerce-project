...
(function($) {
    ...
    //     if (cartStorage in localStorage) {
    //         let cart = "ws"
    //         console.log(cart)
    //     } else {
    //         let cartObj = {
    //             name: $(this).parents().parents().parents().children(".ec-pro-content").children("h5").children("a").html(),
    //             price: $(this).parents().parents().parents().children(".ec-pro-content").children(".ec-price").children(".new-price").html();
    //         }
    //         // localStorage.setItem("cart", JSON.(cartObj))
